...
import { deriveScaleDegreeEvidence, selectReferenceTonicMidi, TONAL_CONFIDENCE_THRESHOLD } from '../src/index.ts';
import type { MelodyNote, TonalCenterAnalysis, TonalCenterSegment, TonalMode } from '../src/index.ts';
